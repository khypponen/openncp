...
public class AutomaticDataCollectorImpl implements AutomaticDataCollector {
    ...
    public AutomaticDataCollectorImpl() {
        try {
            intermediaTransformerList = new TreeMap<String, EasyXsltTransformer>();
            ...
            log.error("Erron, when creating an Instance of AutomaticDataCollector");
    ...
    private String extractDataAndCreateAccordingSqlInserts(Document transaction) throws Exception {
        String processedDocumentCode = null;
        String processedDocumentCodeSystem = null;
        String processedDocumentCodeAndCodeSystemCombination = null;
