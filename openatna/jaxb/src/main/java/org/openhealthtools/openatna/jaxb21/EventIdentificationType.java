...
public class EventIdentificationType {
    ...
    public Date getEventTime() {
        if (eventDateTime != null) {
            return eventDateTime.toGregorianCalendar().getTime();
        }
        return null;
    }
    ...
    public void setEventTime(Date date) {
        if (fac != null) {
            ...
            c.setTime(date);
            this.eventDateTime = fac.newXMLGregorianCalendar(c);
        } else {
            throw new IllegalArgumentException("Error creating DatatypeFactory. Please use XmlGregorianCalendar");
        }
    }
    ...
    public void setEventOutcome(int value) {
        this.eventOutcomeIndicator = new BigInteger(Integer.toString(value));
    }
