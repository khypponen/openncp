...
<%@page import="com.liferay.portal.security.auth.Constants"%>
...
boolean casIsStorkEnabled = PrefsPropsUtil.getString(company.getCompanyId(), Constants.IS_STORK_ENABLED, Constants.IS_STORK_ENABLED);
String casPEPSURL = PrefsPropsUtil.getString(company.getCompanyId(), Constants.PEPS_URL, Constants.PEPS_URL);
String casProviderName = PrefsPropsUtil.getString(company.getCompanyId(), Constants.PROVIDER_NAME, Constants.PROVIDE_NAME);
String casSpSector = PrefsPropsUtil.getString(company.getCompanyId(), Constants.SP_SECTOR, Constants.SP_SECTOR);
String casSpApplication = PrefsPropsUtil.getString(company.getCompanyId(), Constants.SP_APPLICATION, Constants.SP_APPLICATION);
String casSpCountry = PrefsPropsUtil.getString(company.getCompanyId(), Constants.SP_COUNTRY, Constants.SP_COUNTRY);
String casSpQaaLevel = PrefsPropsUtil.getString(company.getCompanyId(), Constants.SP_QAALEVEL, Constants.SP_QAALEVEL);
String casSpReturn = PrefsPropsUtil.getString(company.getCompanyId(), Constants.SP_RETURN, Constants.SP_RETURN);
String casSpMandatoryAttributes = PrefsPropsUtil.getString(company.getCompanyId(), Constants.SP_MANDATORY_ATTRIBUTES, Constants.SP_MANDATORY_ATTRIBUTES);
String casSpOptionalAttributes = PrefsPropsUtil.getString(company.getCompanyId(), Constants.SP_OPTIONAL_ATTRIBUTES, Constants.SP_OPTIONAL_ATTRIBUTES);
...
<aui:fieldset>
	...
	<aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="no-such-user-redirect-url" name='<%= "settings--" + PropsKeys.CAS_NO_SUCH_USER_REDIRECT_URL + "--" %>' type="text" value="<%= casNoSuchUserRedirectURL %>" />
                   ...
                   <aui:input label="enabled" name='<%= "settings--" + Constants.IS_STORK_ENABLED + "--" %>' type="checkbox" value="<%= casIsStorkEnabled %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-provider-name" name='<%= "settings--" + Constants.PROVIDER_NAME + "--" %>' type="text" value="<%= casProviderName %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-sp-sector" name='<%= "settings--" + Constants.SP_SECTOR + "--" %>' type="text" value="<%= casSpSector %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-sp-application" name='<%= "settings--" + Constants.SP_APLICATION + "--" %>' type="text" value="<%= casSpApplication %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-sp-country" name='<%= "settings--" + Constants.SP_COUNTRY + "--" %>' type="text" value="<%= casSpCountry %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-sp-qaalevel" name='<%= "settings--" + Constants.SP_QAALEVEL + "--" %>' type="text" value="<%= casSpQaaLevel %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-sp-return" name='<%= "settings--" + Constants.SP_RETURN + "--" %>' type="text" value="<%= casSpReturn %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-peps-url" name='<%= "settings--" + Constants.PEPS_URL + "--" %>' type="text" value="<%= casPEPSURL %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-mandatory-attributes" name='<%= "settings--" + Constants.SP_MANDATORY_ATTRIBUTES + "--" %>' type="text" value="<%= casSpMandatoryAttributes %>" />
-                   <aui:input cssClass="lfr-input-text-container" helpMessage="cas-no-such-user-redirect-url-help" label="stork-sp-optional-attributes" name='<%= "settings--" + Constants.SP_OPTIONAL_ATTRIBUTES + "--" %>' type="text" value="<%= casSpOptionalAttributes %>" />
