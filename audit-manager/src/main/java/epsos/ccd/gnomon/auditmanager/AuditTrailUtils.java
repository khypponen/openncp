...
public enum AuditTrailUtils {
	...
	INSTANCE;
	private static final Logger log = Logger.getLogger(AuditTrailUtils.class);
	 ...
	 *
	 * @param eventLog
	 *            an EventLog object containing information about the audit
	 *            message.
