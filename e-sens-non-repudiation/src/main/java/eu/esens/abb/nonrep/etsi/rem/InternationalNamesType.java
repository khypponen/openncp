...
@XmlType(name = "InternationalNamesType", namespace = "http://uri.etsi.org/02231/v2#", propOrder = {
    "names"
})
public class InternationalNamesType {

    @XmlElement(name = "Name", required = true)
    protected List<MultiLangNormStringType> names;
     ...
     * 
     */
    public List<MultiLangNormStringType> getNames() {
        if (names == null) {
            names = new ArrayList<MultiLangNormStringType>();
        }
        return this.names;
    }
