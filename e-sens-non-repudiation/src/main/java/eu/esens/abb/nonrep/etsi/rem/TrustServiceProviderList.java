...
@XmlType(name = "TrustServiceProviderListType", namespace = "http://uri.etsi.org/02231/v2#", propOrder = {
    "trustServiceProviders"
})
@XmlRootElement(name = "TrustServiceProviderList", namespace = "http://uri.etsi.org/02231/v2#")
public class TrustServiceProviderList {

    @XmlElement(name = "TrustServiceProvider", required = true)
    protected List<TrustServiceProvider> trustServiceProviders;

    /**
     * Gets the value of the trustServiceProviders property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the trustServiceProviders property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTrustServiceProviders().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TrustServiceProvider }
     * 
     * 
     */
    public List<TrustServiceProvider> getTrustServiceProviders() {
        if (trustServiceProviders == null) {
            trustServiceProviders = new ArrayList<TrustServiceProvider>();
        }
