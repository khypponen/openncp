...
public class TslView extends FrameView implements TreeSelectionListener, ItemListener, MouseListener {
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(epsos.ccd.gnomon.tsleditor.TslEditor.class).getContext().getResourceMap(TslView.class);
		...
		language_OperatorName.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		...
		language_SchemeName.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		language_SchemeName.setName("language_SchemeName"); // NOI18N

		jLabel5.setText(resourceMap.getString("jLabel5.text")); // NOI18N
		jLabel5.setName("jLabel5"); // NOI18N

		language_OperatorAddress.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		language_OperatorAddress.setName("language_OperatorAddress"); // NOI18N

		comboBox_territory.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		comboBox_territory.setName("comboBox_territory"); // NOI18N

		textField_listIssueDateTime.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("yyyy/MM/dd HH:mm:ss"))));
		...
		textField_nextUpdate.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("yyyy/MM/dd HH:mm:ss"))));
		...
		TSLEnvelopePanelLayout.setHorizontalGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(TSLEnvelopePanelLayout.createSequentialGroup().addContainerGap()
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jSeparator3, javax.swing.GroupLayout.PREFERRED_SIZE, 730, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGroup(javax.swing.GroupLayout.Alignment.LEADING, TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(jSeparator4).addGroup(javax.swing.GroupLayout.Alignment.LEADING,
								TSLEnvelopePanelLayout.createSequentialGroup().addGap(24, 24, 24)
										.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(TSLEnvelopePanelLayout.createSequentialGroup().addGap(24, 24, 24)
												.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														.addGroup(TSLEnvelopePanelLayout.createSequentialGroup().addGap(8, 8, 8)
																.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel1)
																		.addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel4)))
														.addComponent(jLabel5).addComponent(jLabel15))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(textField_OperatorName).addComponent(textField_ID, javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(textField_SequenceNumber, javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(textField_SchemeName, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 486, javax.swing.GroupLayout.PREFERRED_SIZE))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(language_OperatorAddress, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(language_OperatorName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(language_SchemeName,
														javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
												.addGroup(
														TSLEnvelopePanelLayout.createSequentialGroup().addGap(72, 72, 72)
																.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel9).addComponent(jLabel6).addComponent(jLabel7).addComponent(jLabel8))
																.addPreferredGap(
																		javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(textField_countryName).addComponent(textField_postCode)
																		.addComponent(
																				textField_locality)
																		.addComponent(textField_streetAddress, javax.swing.GroupLayout.PREFERRED_SIZE, 464, javax.swing.GroupLayout.PREFERRED_SIZE)))
										.addGroup(TSLEnvelopePanelLayout.createSequentialGroup().addGap(47, 47, 47)
												.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
														.addGroup(javax.swing.GroupLayout.Alignment.LEADING,
																TSLEnvelopePanelLayout.createSequentialGroup().addComponent(jLabel10).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(textField_electronicAddress1,
																		javax.swing.GroupLayout.PREFERRED_SIZE, 492, javax.swing.GroupLayout.PREFERRED_SIZE))
												.addGroup(javax.swing.GroupLayout.Alignment.LEADING, TSLEnvelopePanelLayout.createSequentialGroup()
														.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel14).addComponent(jLabel13).addComponent(jLabel12).addComponent(jLabel3)
																.addComponent(jLabel16))
														.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
														.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																.addComponent(textField_DistributionPoint, javax.swing.GroupLayout.DEFAULT_SIZE, 492, Short.MAX_VALUE)
																.addComponent(comboBox_territory, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
																.addComponent(textField_electronicAddress3, javax.swing.GroupLayout.DEFAULT_SIZE, 492, Short.MAX_VALUE)
																.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(textField_nextUpdate, javax.swing.GroupLayout.Alignment.LEADING)
																		.addComponent(textField_listIssueDateTime, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE))))
												.addGroup(TSLEnvelopePanelLayout.createSequentialGroup().addComponent(jLabel11).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(textField_electronicAddress2))))))))
				.addContainerGap(39, Short.MAX_VALUE)));
		TSLEnvelopePanelLayout.setVerticalGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(TSLEnvelopePanelLayout.createSequentialGroup().addGap(28, 28, 28)
						.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(textField_SequenceNumber, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel2))
				.addGroup(TSLEnvelopePanelLayout.createSequentialGroup()
						.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel1).addComponent(textField_ID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(38, 38, 38)))
				.addGap(18, 18, 18)
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_SchemeName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel4)
						.addComponent(language_SchemeName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addGap(20, 20, 20)
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel15)
						.addComponent(textField_OperatorName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(language_OperatorName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(22, 22, 22)
				.addComponent(jSeparator3, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addGroup(
						TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel5)
								.addComponent(language_OperatorAddress, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(
								TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addGroup(
												TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
														.addComponent(
																jLabel9)
														.addComponent(textField_countryName, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGroup(TSLEnvelopePanelLayout.createSequentialGroup()
										.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(textField_streetAddress, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel6))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(textField_locality, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel7))
										.addGap(14, 14, 14)
										.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel8).addComponent(textField_postCode, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGap(29, 29, 29)))
						.addGap(21, 21, 21).addComponent(jSeparator4, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel10).addComponent(textField_electronicAddress1, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
								javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel11).addComponent(textField_electronicAddress2, javax.swing.GroupLayout.PREFERRED_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_electronicAddress3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel12))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(comboBox_territory, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel13))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_listIssueDateTime, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel3).addComponent(textField_nextUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLEnvelopePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel16).addComponent(textField_DistributionPoint, javax.swing.GroupLayout.PREFERRED_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addContainerGap(68, Short.MAX_VALUE)));
		...
		mainPanelLayout
				.setHorizontalGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jSplitPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 845, Short.MAX_VALUE));
		mainPanelLayout
				.setVerticalGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jSplitPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 601, Short.MAX_VALUE));
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(epsos.ccd.gnomon.tsleditor.TslEditor.class).getContext().getActionMap(TslView.class, this);
		...
		statusPanelLayout.setHorizontalGroup(statusPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(statusPanelSeparator, javax.swing.GroupLayout.DEFAULT_SIZE, 845, Short.MAX_VALUE)
				.addGroup(statusPanelLayout.createSequentialGroup().addContainerGap().addComponent(statusMessageLabel).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 675, Short.MAX_VALUE)
		...
		statusPanelLayout.setVerticalGroup(statusPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(statusPanelLayout.createSequentialGroup().addComponent(statusPanelSeparator, javax.swing.GroupLayout.PREFERRED_SIZE, 2, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGroup(statusPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
		...
		fileChooserLayout.setHorizontalGroup(fileChooserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(fileChooserLayout.createSequentialGroup().addContainerGap().addComponent(jFileChooser1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addContainerGap(30, Short.MAX_VALUE)));
		fileChooserLayout.setVerticalGroup(fileChooserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(fileChooserLayout.createSequentialGroup().addContainerGap().addComponent(jFileChooser1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addContainerGap(61, Short.MAX_VALUE)));
		...
		language_Provider_Name.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		language_Provider_Name.setName("language_Provider_Name"); // NOI18N

		textField_Provider_ElectronicAddress3.setText(resourceMap.getString("textField_Provider_ElectronicAddress3.text")); // NOI18N
		textField_Provider_ElectronicAddress3.setName("textField_Provider_ElectronicAddress3"); // NOI18N

		jLabel25.setText(resourceMap.getString("jLabel25.text")); // NOI18N
		jLabel25.setName("jLabel25"); // NOI18N

		textField_Provider_ElectronicAddress1.setText(resourceMap.getString("textField_Provider_ElectronicAddress1.text")); // NOI18N
		...
		textField_Provider_ElectronicAddress2.setText(resourceMap.getString("textField_Provider_ElectronicAddress2.text")); // NOI18N
		...
		language_Provider_Information.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		language_Provider_Information.setName("language_Provider_Information"); // NOI18N

		language_Provider_Address.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		...
		TSLProviderPanelLayout
				.setHorizontalGroup(
						TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(TSLProviderPanelLayout.createSequentialGroup().addContainerGap()
										.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(jSeparator5)
												.addGroup(javax.swing.GroupLayout.Alignment.LEADING,
														TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
																.addComponent(jSeparator6, javax.swing.GroupLayout.PREFERRED_SIZE, 646, javax.swing.GroupLayout.PREFERRED_SIZE).addGroup(javax.swing.GroupLayout.Alignment.LEADING,
																		TSLProviderPanelLayout.createSequentialGroup().addGap(11, 11, 11)
																				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
																						.addGroup(javax.swing.GroupLayout.Alignment.LEADING,
																								TSLProviderPanelLayout.createSequentialGroup().addComponent(jLabel26).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																										.addComponent(textField_Provider_ElectronicAddress2))
																				.addGroup(javax.swing.GroupLayout.Alignment.LEADING,
																						TSLProviderPanelLayout.createSequentialGroup().addComponent(jLabel25).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																								.addComponent(textField_Provider_ElectronicAddress1, javax.swing.GroupLayout.PREFERRED_SIZE, 466, javax.swing.GroupLayout.PREFERRED_SIZE))
																						.addGroup(javax.swing.GroupLayout.Alignment.LEADING,
																								TSLProviderPanelLayout.createSequentialGroup()
																										.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel28).addComponent(jLabel27))
																										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																										.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																												.addComponent(textField_Provider_Information, javax.swing.GroupLayout.DEFAULT_SIZE, 464, Short.MAX_VALUE)
																												.addComponent(textField_Provider_ElectronicAddress3))))
																				.addPreferredGap(
																						javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																				.addComponent(language_Provider_Information, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
																						javax.swing.GroupLayout.PREFERRED_SIZE)))
												.addGroup(javax.swing.GroupLayout.Alignment.LEADING,
														TSLProviderPanelLayout.createSequentialGroup().addGap(29, 29, 29)
																.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
																		.addGroup(TSLProviderPanelLayout.createSequentialGroup()
																				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel20).addComponent(jLabel17))
																				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
														.addGroup(TSLProviderPanelLayout.createSequentialGroup()
																.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel22).addComponent(jLabel21).addComponent(jLabel23)
																		.addComponent(jLabel24))
																.addGap(18, 18, 18)))
						.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(textField_Provider_CountryName).addComponent(textField_Provider_PostCode)
								.addComponent(textField_Provider_Locality).addGroup(TSLProviderPanelLayout.createSequentialGroup().addGap(2, 2, 2).addComponent(textField_Provider_StreetAddress))
								.addGroup(TSLProviderPanelLayout.createSequentialGroup().addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(textField_providerName, javax.swing.GroupLayout.DEFAULT_SIZE, 462,
										Short.MAX_VALUE)))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(language_Provider_Address, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(language_Provider_Name, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))).addContainerGap(39, Short.MAX_VALUE)));
		TSLProviderPanelLayout.setVerticalGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(TSLProviderPanelLayout.createSequentialGroup().addGap(37, 37, 37)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_providerName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel17)
						.addComponent(language_Provider_Name, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jSeparator5, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(3, 3, 3).addComponent(jLabel20)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_Provider_StreetAddress, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel21)
						.addComponent(language_Provider_Address, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_Provider_Locality, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel22))
				.addGap(14, 14, 14)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_Provider_PostCode, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel23))
				.addGap(13, 13, 13)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(textField_Provider_CountryName, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jLabel24))
				.addGap(18, 18, 18).addComponent(jSeparator6, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(textField_Provider_ElectronicAddress1, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jLabel25))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_Provider_ElectronicAddress2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel26))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_Provider_ElectronicAddress3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel27))
				.addGap(18, 18, 18)
				.addGroup(TSLProviderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel28)
						.addComponent(textField_Provider_Information, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(language_Provider_Information, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
		...
		combo_ServiceTypeIdentifier.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		...
		language_Service_Name.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		...
		combo_Service_Status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		combo_Service_Status.setName("combo_Service_Status"); // NOI18N

		jLabel32.setText(resourceMap.getString("jLabel32.text")); // NOI18N
		jLabel32.setName("jLabel32"); // NOI18N

		textField_Service_StartingTime.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("yyyy/MM/dd HH:mm:ss"))));
		textField_Service_StartingTime.setToolTipText(resourceMap.getString("textField_Service_StartingTime.toolTipText")); // NOI18N
				...
				.setHorizontalGroup(
						TSLServicePanelLayout
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										TSLServicePanelLayout.createSequentialGroup().addGap(59, 59, 59)
												.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														.addGroup(TSLServicePanelLayout.createSequentialGroup()
																.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel34).addComponent(jLabel31).addComponent(jLabel30)
																		.addComponent(jLabel32).addComponent(jLabel33).addComponent(jLabel35, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE))
														.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
														.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
																.addComponent(combo_Service_Status, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
																.addComponent(textField_Service_StartingTime, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(textField_Service_SupplyPoint2)
																.addComponent(textField_Service_SupplyPoint3, javax.swing.GroupLayout.DEFAULT_SIZE, 284, Short.MAX_VALUE).addComponent(textField_Service_SupplyPoint1)))
						.addGroup(
								TSLServicePanelLayout.createSequentialGroup().addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel29).addComponent(jLabel18))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(combo_ServiceTypeIdentifier, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGroup(TSLServicePanelLayout.createSequentialGroup().addGap(1, 1, 1)
														.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(addCertificateButton)
																.addGroup(TSLServicePanelLayout.createSequentialGroup()
																		.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
																				.addComponent(textField_Service_Name, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
																				.addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
																.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																		.addGroup(TSLServicePanelLayout.createSequentialGroup().addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																				.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
																						.addComponent(viewCertificateButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
																								Short.MAX_VALUE)
																						.addComponent(deleteCertificateButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
																								Short.MAX_VALUE)))
																		.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, TSLServicePanelLayout.createSequentialGroup().addGap(37, 37, 37).addComponent(language_Service_Name,
																				javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))))))))
												.addContainerGap(86, Short.MAX_VALUE)));
		TSLServicePanelLayout.setVerticalGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(TSLServicePanelLayout.createSequentialGroup().addGap(29, 29, 29)
						.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(combo_ServiceTypeIdentifier, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel18))
				.addGap(18, 18, 18)
				.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_Service_Name, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(language_Service_Name, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel29))
				.addGap(18, 18, 18)
				.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel30)
						.addGroup(TSLServicePanelLayout.createSequentialGroup().addComponent(viewCertificateButton).addGap(8, 8, 8).addComponent(deleteCertificateButton))
						.addGroup(TSLServicePanelLayout.createSequentialGroup().addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(addCertificateButton)))
				.addGap(18, 18, 18)
				.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(combo_Service_Status, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel31))
				.addGap(13, 13, 13)
				.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel32).addComponent(textField_Service_StartingTime, javax.swing.GroupLayout.PREFERRED_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addGap(18, 18, 18)
				.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel33).addComponent(textField_Service_SupplyPoint1, javax.swing.GroupLayout.PREFERRED_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addGap(17, 17, 17)
				.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(textField_Service_SupplyPoint2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel34)).addGap(16, 16, 16)
				.addGroup(TSLServicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel35).addComponent(textField_Service_SupplyPoint3, javax.swing.GroupLayout.PREFERRED_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addContainerGap(31, Short.MAX_VALUE)));
		...
		textField_Signature_CanonicalizationMethod.setText(resourceMap.getString("textField_Signature_CanonicalizationMethod.text")); // NOI18N
		...
		TSLSignaturePanelLayout
				.setHorizontalGroup(
						TSLSignaturePanelLayout
								.createParallelGroup(
										javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(
										TSLSignaturePanelLayout.createSequentialGroup().addGap(38, 38, 38)
												.addGroup(
														TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel43).addComponent(jLabel42).addComponent(jLabel19).addComponent(jLabel44)
										...
										.addPreferredGap(
												javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(signButton)
						.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(textField_Signature_CanonicalizationMethod, javax.swing.GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)
								.addComponent(textField_Signature_SignatureMethod, javax.swing.GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE).addComponent(signatureIssuerName, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE)
								.addComponent(signatureSerialNumber).addComponent(signatureValidFrom).addComponent(signatureSubjectName).addComponent(signatureValidUntil, javax.swing.GroupLayout.Alignment.TRAILING)))
				.addContainerGap(249, Short.MAX_VALUE)));
		TSLSignaturePanelLayout
				.setVerticalGroup(
						TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(TSLSignaturePanelLayout.createSequentialGroup()
										.addGroup(TSLSignaturePanelLayout
												.createParallelGroup(
														javax.swing.GroupLayout.Alignment.LEADING)
												.addGroup(TSLSignaturePanelLayout.createSequentialGroup().addGap(31, 31, 31)
														.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
																.addComponent(textField_Signature_CanonicalizationMethod, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
																.addComponent(jLabel19))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel42).addComponent(textField_Signature_SignatureMethod, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jLabel43)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel44).addComponent(signatureIssuerName, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel45).addComponent(signatureSerialNumber, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(12, 12, 12)
						.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel46).addComponent(signatureValidFrom, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(signatureValidUntil, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel47)))
				.addGroup(TSLSignaturePanelLayout.createSequentialGroup().addGap(238, 238, 238)
						.addGroup(TSLSignaturePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(signatureSubjectName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel48)))).addGap(18, 18, 18)
				.addComponent(signButton).addContainerGap(113, Short.MAX_VALUE)));
		...
		digitalIdDialogLayout
				.setHorizontalGroup(
						digitalIdDialogLayout
								.createParallelGroup(
										javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(digitalIdDialogLayout.createSequentialGroup().addGap(25, 25, 25)
										.addGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addGroup(digitalIdDialogLayout.createSequentialGroup()
														.addGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel38).addComponent(jLabel39).addComponent(jLabel40).addComponent(jLabel41)
																.addComponent(jLabel36).addComponent(jLabel37))
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
														.addComponent(certificateSubjectName, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addComponent(certificateValidUntil, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addComponent(certificateValidFrom, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
														.addComponent(certificateSerialNumber, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addComponent(certificateIssuerName, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE)))
				.addGroup(digitalIdDialogLayout.createSequentialGroup().addGap(180, 180, 180).addComponent(jButton2))).addContainerGap(64, Short.MAX_VALUE)));
		digitalIdDialogLayout.setVerticalGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(digitalIdDialogLayout.createSequentialGroup().addGap(20, 20, 20).addComponent(jLabel37).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel36).addComponent(certificateIssuerName, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel38).addComponent(certificateSerialNumber, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel39).addComponent(certificateValidFrom, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel40).addComponent(certificateValidUntil, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(digitalIdDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel41).addComponent(certificateSubjectName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jButton2).addContainerGap(22, Short.MAX_VALUE)));
		...
		javax.swing.GroupLayout certificateFileDialogLayout = new javax.swing.GroupLayout(certificateFileDialog.getContentPane());
		certificateFileDialog.getContentPane().setLayout(certificateFileDialogLayout);
		certificateFileDialogLayout.setHorizontalGroup(certificateFileDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 582, Short.MAX_VALUE)
				.addGroup(certificateFileDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(certificateFileDialogLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
						.addComponent(certificateFileChooser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(0, 0, Short.MAX_VALUE))));
		certificateFileDialogLayout.setVerticalGroup(certificateFileDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 397, Short.MAX_VALUE)
				.addGroup(certificateFileDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(certificateFileDialogLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
						.addComponent(certificateFileChooser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(0, 0, Short.MAX_VALUE))));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addGap(123, 123, 123).addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel50).addComponent(jLabel49).addComponent(jLabel51))
						.addGap(18, 18, 18)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(keyStorePassword, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
								.addComponent(keyPassword, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(keyAlias, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap(151, Short.MAX_VALUE)));
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel49).addComponent(keyStorePassword, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel50).addComponent(keyPassword, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
				.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel51).addComponent(keyAlias, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
				jPanel3Layout.createSequentialGroup().addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(signatureFileChooser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()));
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addGap(20, 20, 20)
				.addComponent(signatureFileChooser, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
												...
												.addGroup(
														jPanel1Layout
																...
																.addGroup(jPanel1Layout.createSequentialGroup()
																		...
																		.addGap(19, 19, 19))
																.addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel52).addContainerGap(495, Short.MAX_VALUE))
																.addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel53).addContainerGap(502, Short.MAX_VALUE)))));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(jLabel52).addGap(8, 8, 8)
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 16, Short.MAX_VALUE).addComponent(jLabel53).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()));

		javax.swing.GroupLayout signatureFileDialogLayout = new javax.swing.GroupLayout(signatureFileDialog.getContentPane());
		signatureFileDialog.getContentPane().setLayout(signatureFileDialogLayout);
		signatureFileDialogLayout.setHorizontalGroup(signatureFileDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(signatureFileDialogLayout.createSequentialGroup()
				.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
		signatureFileDialogLayout.setVerticalGroup(
				signatureFileDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE));
		...
		ftpUploadPathField.setText(resourceMap.getString("ftpUploadPathField.text")); // NOI18N
				...
				.setHorizontalGroup(
						ftpDialogLayout
								.createParallelGroup(
										javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										ftpDialogLayout.createSequentialGroup().addContainerGap(58, Short.MAX_VALUE)
												.addGroup(
														ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel58)
																.addGroup(ftpDialogLayout.createSequentialGroup()
																		.addGroup(ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel54).addComponent(jLabel55).addComponent(jLabel56).addComponent(
																				jLabel57))
						.addGap(27, 27, 27)
						.addGroup(ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jButton1).addGroup(ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(ftpUploadPathField)
										.addComponent(ftpServerField, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE).addComponent(ftpUserName).addComponent(ftpPrivateKey, javax.swing.GroupLayout.Alignment.TRAILING)))))
				.addGap(48, 48, 48)));
		ftpDialogLayout.setVerticalGroup(ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(ftpDialogLayout.createSequentialGroup().addContainerGap().addComponent(jLabel58).addGap(15, 15, 15)
						.addGroup(ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel54).addComponent(ftpServerField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE))
				.addGap(18, 18, 18)
				.addGroup(ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel55).addComponent(ftpUploadPathField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.PREFERRED_SIZE))
				.addGap(18, 18, 18)
				.addGroup(ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(ftpUserName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jLabel56))
				.addGap(18, 18, 18)
				.addGroup(ftpDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(ftpPrivateKey, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel57)).addGap(52, 52, 52).addComponent(jButton1)
		...
		if (evt.getActionCommand().equals("CancelSelection"))
			...
			if (crtFile != null && crtFile.length() > 0) {
				try {
					...
					try {
						X509Certificate certificate = (X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(x509CertificateData));

						if (certificate != null && this.currentTreeNode != null && this.currentTreeNode.getUserObject() instanceof TrustService) {
							...
							DigitalIdentityListType idList = service.getTSPService().getServiceInformation().getServiceDigitalIdentity();
							if (idList == null) {
	...
	private void signatureFileChooserActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_signatureFileChooserActionPerformed
		if (!evt.getActionCommand().equals("CancelSelection")) {
			if (ValidatorUtil.isNull(this.keyAlias) || ValidatorUtil.isNull(this.keyPassword) || ValidatorUtil.isNull(this.keyStorePassword)) {
				JOptionPane.showMessageDialog(this.signatureFileDialog, "You must enter all the key store details required first", "Error Message", JOptionPane.ERROR_MESSAGE);
				return;
			}
			...
			try {
				...
				PrivateKey privateKey = (PrivateKey) keyStore.getKey(new String(this.keyAlias.getPassword()), this.keyPassword.getPassword());
				...
				this.trustServiceList = TrustServiceListFactory.newInstance(this.trustServiceList.tslDocument, this.tslFile);
				...
				e.printStackTrace();
				JOptionPane.showMessageDialog(this.jSplitPane1, "XML Signature of TSL Failed", "XML Signature Error", JOptionPane.ERROR_MESSAGE);
			}
	...
	@Action
	/**
	 * This is called when the user chooses the "New" option from them menubar.
	 * A new empty TSL object is created and initialized to comply to the EPSOS
	 * specification. The empty TSL is shown to the user in the corresponding
	 * frames of the UI.
	 */
	public void newTSL() {
		emptyAllFormFields();
	...
	@Action
	/**
	 * This is called when the user chooses the "Save" option from the menubar.
	 * A validation is performed on the currently built TSL and if it is valid
	 * the list is saved as a file with the same name in the filesystem. If a
	...
	public boolean saveTSL() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this.jSplitPane1,
					"A new XML document has been saved at the location: \n\t" + this.tslFile.getAbsolutePath() + "\n Any previous file with the same name has been copied with a version number using the current date and time.", "File Saved",
	...
	@Action
	/**
	 * This is called when the user chooses the "Preview" link of the menubar.
	 ...
	 * subdirectory "TslEditor". The file can be then copied/printed by the
			...
			try {
				...
				try {
					...
					try {
						...
						JOptionPane.showMessageDialog(this.jSplitPane1, "A pdf document of the preview has been created at the location: \n\t" + pdfFile.getAbsolutePath(), "PDF Saved", JOptionPane.INFORMATION_MESSAGE);
					}
				}
			}
		} catch (Exception e) {
			JOptionPane.showMessageDialog(this.jSplitPane1, "No pdf preview could be created at this time. \nPlease check that you have entered all fields correctly, \nby means of attempting to save this TSL file first.", "PDF Creation Error",
	...
	@Action
	/**
	 * This is called when the user chooses the "Open" option from the menubar.
	 ...
	 * It opens the SMP window for TSL-to-SMP transformation and SMP files upload.
	 */
	public void openSMP() {
	...
	public void addService(String identifier) {
		if (this.currentPopupSelectedTreePath != null) {
			DefaultMutableTreeNode treeNode = (DefaultMutableTreeNode) this.currentPopupSelectedTreePath.getLastPathComponent();
			...
			if (obj instanceof TrustServiceProvider) {
				...
				((DefaultTreeModel) this.jTree.getModel()).nodesWereInserted(treeNode, new int[] { treeNode.getIndex(newChild) });
				...
				if (obj instanceof TrustServiceProvider) {
					...
					DefaultMutableTreeNode newChild = new DefaultMutableTreeNode(newService);
					parent.add(newChild);
					((DefaultTreeModel) this.jTree.getModel()).nodesWereInserted(parent, new int[] { parent.getIndex(newChild) });
				}
			} else {
				// do nothing
			}
				...
				if (obj instanceof TrustServiceProvider) {
					...
					if (services != null) {
						for (TSPServiceType s : services) {
							if (serviceToDelete.getTSPService().getServiceInformation().getServiceTypeIdentifier().equals(s.getServiceInformation().getServiceTypeIdentifier())) {
								services.remove(s);

								// change tree model also
								int index = parent.getIndex(treeNode);
								parent.remove(treeNode);
								((DefaultTreeModel) this.jTree.getModel()).nodesWereRemoved(parent, new int[] { index }, new Object[] { treeNode });
	 ...
	 * needed.
	 */
	private void initializeEmptyTSL() {
		...
		try {
			schemeType.setListIssueDateTime(DatatypeFactory.newInstance().newXMLGregorianCalendar((GregorianCalendar) Calendar.getInstance()));
		} catch (Exception e1) {
		}

		listType.setId(ValidatorUtil.TSL_ID + "GR");
		listType.setTSLTag(ValidatorUtil.TSL_TAG);
		listType.setSchemeInformation(schemeType);

		this.trustServiceList.setSchemeName(ValidatorUtil.TSL_SCHEME_NAME + "Greece(GR)");
		this.trustServiceList.setStatusDeterminationApproach(ValidatorUtil.TSL_STATUS_DETERMINATION_APPROACH);
		this.trustServiceList.setSchemeTerritory("GR");
		...
		TrustService identServA = initEmptyService(ComboBoxesUtil.SERVICE_IDENTIFIER_PATIENT_IDENTIFICATION, "Patient Idenitification");
	...
	private TrustService initEmptyService(String identifier, String name) {
		...
		try {
			vpnInfoType.setStatusStartingTime(DatatypeFactory.newInstance().newXMLGregorianCalendar((GregorianCalendar) Calendar.getInstance()));
		} catch (Exception e) {
		}
	...
	public void initTree() {
		...
		if (this.trustServiceList.getTrustServiceProviders() != null && this.trustServiceList.getTrustServiceProviders().size() > 0) {
		...
		if (currentTreeNode != null && source instanceof JComboBox && item instanceof String) {
			...
			if (e.getStateChange() == ItemEvent.DESELECTED) {
				...
				if (combo.getName().equals("language_OperatorAddress")) {
					...
					} else if (ValidatorUtil.isNotNull(this.textField_countryName) || ValidatorUtil.isNotNull(this.textField_locality) || ValidatorUtil.isNotNull(this.textField_postCode) || ValidatorUtil.isNotNull(this.textField_streetAddress)) {
					...
					if (currentTreeNode.getUserObject() instanceof TrustServiceProvider) {
						...
						} else if (ValidatorUtil.isNotNull(this.textField_Provider_CountryName) || ValidatorUtil.isNotNull(this.textField_Provider_Locality) || ValidatorUtil.isNotNull(this.textField_Provider_PostCode)
					...
					if (currentTreeNode.getUserObject() instanceof TrustServiceProvider) {
						...
						if (ValidatorUtil.isNotNull(this.textField_Provider_Information)) {
							if (provider.getInformationUris(locale) != null && provider.getInformationUris(locale).size() > 0) {
								...
								NonEmptyMultiLangURIListType tspInformationURI = provider.getTSP().getTSPInformation().getTSPInformationURI();
					...
					if (currentTreeNode.getUserObject() instanceof TrustService) {
						...
						if (ValidatorUtil.isNotNull(serviceName)) {
							InternationalNamesType tspNames = service.getTSPService().getServiceInformation().getServiceName();
							if (tspNames == null) {
								tspNames = objectFactory.createInternationalNamesType();
							}
	...
	private void popupTriggered(MouseEvent e) {
		...
		if (this.currentPopupSelectedTreePath != null) {
			DefaultMutableTreeNode node = (DefaultMutableTreeNode) this.currentPopupSelectedTreePath.getLastPathComponent();
																				...
																				// case
			{
				...
				// List<TrustService> oldServices = provider.getTrustServices();
				List<TSPServiceType> oldServices = provider.getTSP().getTSPServices().getTSPService();
				if (oldServices != null) {
					// for (TrustService s: oldServices)
				...
				if (serviceChoices != null && serviceChoices.size() > 0) {
	...
	private void readModelFields(boolean firstTime) {
		if (this.trustServiceList != null) {
			...
			if (firstTime) {
				...
				// if (listType.getId() != null &&
				// listType.getId().contains("-"))
				// {
				// countryCode =
				// listType.getId().substring(listType.getId().lastIndexOf("-")+1);
				// defaultLocale =
				// ComboBoxesUtil.getLocaleFromCountryCode(countryCode);
				// }
			...
			this.textField_SequenceNumber.setText(this.trustServiceList.getSequenceNumber() != null ? this.trustServiceList.getSequenceNumber().toString() : "");
			...
			if (this.trustServiceList.getListIssueDateTime() != null) {
				this.textField_listIssueDateTime.setText(dateTimeFormatter.format(this.trustServiceList.getListIssueDateTime().toDate()));
			}

			if (this.trustServiceList.getNextUpdate() != null) {
				this.textField_nextUpdate.setText(dateTimeFormatter.format(this.trustServiceList.getNextUpdate().toDate()));
			}

			if (listType.getSchemeInformation().getDistributionPoints() != null && listType.getSchemeInformation().getDistributionPoints().getURI() != null && listType.getSchemeInformation().getDistributionPoints().getURI().size() > 0) {
				this.textField_DistributionPoint.setText(listType.getSchemeInformation().getDistributionPoints().getURI().get(0));
			}
		}
	}
					...
					if (obj instanceof JAXBElement) {
						...
						if (el.getValue() instanceof X509DataType) {
							try {
								...
								byte[] cert = (byte[]) ((JAXBElement) x509.getX509IssuerSerialOrX509SKIOrX509SubjectName().get(0)).getValue();
								if (cert != null && cert.length > 0) {
									X509Certificate certificate = (X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(cert));
									if (certificate != null) {
										this.signatureIssuerName.setText(certificate.getIssuerX500Principal().getName());
										...
										this.signatureSubjectName.setText(certificate.getSubjectX500Principal().getName());
									}
								}
							} catch (Exception e) {
							}
	...
	public boolean validate() {
		...
		if (this.trustServiceList == null)
			...
			if (providers != null) {
				...
				if (!ncpAFound || !ncpBFound) {
					ValidatorUtil.appendErrorMessage(errorString, "Exactly 2 Trust Service Providers must be present, NCP-A and NCP-B");
				}
			}
		...
		if (errorString.length() > 0) {
			...
			errorArea.setText("Are you sure you want to save and/or upload this file? The following validation Errors were found\n\n" + errorString);
			...
			// JOptionPane.ERROR_MESSAGE);
			int optionChosen = JOptionPane.showConfirmDialog(this.jSplitPane1, errorScrollPane, "Validation Errors!", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
			if (optionChosen == 0)
				return true;
			else
				return false;
	...
	private void writeModelFields(TrustServiceProvider provider) {
		...
		if (provider.getTSP().getTSPInformation().getTSPAddress().getElectronicAddress() == null)
			provider.getTSP().getTSPInformation().getTSPAddress().setElectronicAddress(objectFactory.createElectronicAddressType());
		...
		if (this.trustServiceList != null) {
			...
			if (ValidatorUtil.isNotNull(this.textField_DistributionPoint)) {
				if (listType.getSchemeInformation().getDistributionPoints() == null || listType.getSchemeInformation().getDistributionPoints().getURI() == null || listType.getSchemeInformation().getDistributionPoints().getURI().size() == 0) {
					...
					listType.getSchemeInformation().getDistributionPoints().getURI().set(0, this.textField_DistributionPoint.getText());
				}
			}
		}
	}
	...
	public void viewCertificate() {
		if (this.certificateList.getSelectedValue() == null)
			JOptionPane.showMessageDialog(this.jSplitPane1, "You must first select the certificate you want to view from the list", "Certificate Selection", JOptionPane.ERROR_MESSAGE);
		else {
			...
			if (this.currentTreeNode != null && this.currentTreeNode.getUserObject() instanceof TrustService) {
				TrustService service = (TrustService) this.currentTreeNode.getUserObject();
				List<DigitalIdentityType> ids = service.getTSPService().getServiceInformation().getServiceDigitalIdentity().getDigitalId();
				if (ids != null) {
					try {
						for (DigitalIdentityType id : ids) {
							if (id.getX509Certificate() != null) {
								X509Certificate certificate = (X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(id.getX509Certificate()));
								if (certificate != null) {
									String cSubj = ValidatorUtil.getUniqueSubjectLine(certificate);
									if (cSubj.equals(crtSubject)) {
										// found certificate to show
										this.certificateIssuerName.setText(certificate.getIssuerX500Principal().getName());
										...
										this.certificateSubjectName.setText(certificate.getSubjectX500Principal().getName());
	...
	public void deleteCertificate() {
		if (this.certificateList.getSelectedValue() == null)
			JOptionPane.showMessageDialog(this.jSplitPane1, "You must first select the certificate you want to delete from the list", "Certificate Selection", JOptionPane.ERROR_MESSAGE);
		else {
			if (JOptionPane.showConfirmDialog(this.jSplitPane1, "Are you sure you want to delete this Certificate? ") == 0) {
				String crtSubject = (String) this.certificateList.getSelectedValue();
				if (this.currentTreeNode != null && this.currentTreeNode.getUserObject() instanceof TrustService) {
					TrustService service = (TrustService) this.currentTreeNode.getUserObject();
					List<DigitalIdentityType> ids = service.getTSPService().getServiceInformation().getServiceDigitalIdentity().getDigitalId();
								...
								if (id.getX509Certificate() != null) {
									...
									if (certificate != null) {
										...
										if (cSubj.equals(crtSubject)) {
											...
											((DefaultListModel) this.certificateList.getModel()).removeElement(crtSubject);
											break;
										}
									}
								}
	...
	public void ftpUploadTSL() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this.jSplitPane1, "Upload to site \'" + destFolder + "\' was successful!", "Upload Success!", JOptionPane.INFORMATION_MESSAGE);
