 ...
 */
@Component
public class ItalyPSStatus implements NcpStatusInterface, Serializable {

    private static final long serialVersionUID = 9084773030426183950L;
    private static final Logger LOGGER = LoggerFactory.getLogger(ItalyPSStatus.class);
    ...
    public Boolean getStatus() {
        ...
        try {
            ...
            patientValueList.add(new PatientIdVO("patient.search.fiscal.code domain", "2.16.840.1.113883.2.9.4.3.2", "NTSDNN80A19D612X"));
            patientValueList.add(new PatientIdVO("EIHC serial number domain", "2.16.840.1.113883.2.9.4.1.4", "64681"));
    ...
    public String getTitle() {
        return "Patientöversikter Italien";
    }
}
