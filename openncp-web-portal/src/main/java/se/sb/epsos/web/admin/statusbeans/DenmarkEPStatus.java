 ...
 */
@Component
public class DenmarkEPStatus implements NcpStatusInterface, Serializable {

    private static final long serialVersionUID = 630555535783249495L;
    private static final Logger LOGGER = LoggerFactory.getLogger(DenmarkEPStatus.class);
    ...
    public Boolean getStatus() {
        ...
        try {
            ...
            patientValueList.add(new PatientIdVO("patient.data.unique.identifier", "2.16.17.710.802.1000.990.1", "2601010003"));

            List<Person> persons = serviceFacade.queryForPatient(null, patientValueList, new CountryVO("DK", "Danmark", "2.16.17.710.802.1000.990.1"));
            if (persons.size() > 0) {
