 ...
 */
@Component
public class SpainPSStatus implements NcpStatusInterface, Serializable {
	private static final long serialVersionUID = -5376273706693549750L;
	private static final Logger LOGGER = LoggerFactory.getLogger(SpainPSStatus.class);
    ...
    public Boolean getStatus() {
        ...
        try { 
            ...
            patientValueList.add(new PatientIdVO ("patient.data.unique.identifier.spain domain", "2.16.724.4.41", "1199925"));
            patientValueList.add(new PatientIdVO ("patient.data.region.spain", "2.16.724.4.42", "803409"));

            List<Person> persons = serviceFacade.queryForPatient(null, patientValueList, new CountryVO("ES", "Spanien", "2.16.17.710.806.1000.990.1"));
            if(persons.size() > 0){
    ...
    public String getTitle() {
        return "Patientöversikter Spanien";
    }
}
