 ...
 */
@Component
public class DenmarkPSStatus implements NcpStatusInterface, Serializable {

    private static final long serialVersionUID = 5007896531914779029L;
    private static final Logger LOGGER = LoggerFactory.getLogger(DenmarkPSStatus.class);
    ...
    public String getTitle() {
        return "Patientöversikter Danmark";
    }
}
