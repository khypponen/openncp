 ...
 */
@Component
public class CzechPSStatus implements NcpStatusInterface, Serializable {

    private static final long serialVersionUID = 5909087446549125575L;
    private static final Logger LOGGER = LoggerFactory.getLogger(CzechPSStatus.class);

    @Override
    public String getTitle() {
        return "Patientöversikter Tjeckien";
    }
    ...
    public Boolean getStatus() {
        ...
        try {
            ...
            patientValueList.add(new PatientIdVO("patient.search.patient.id", "2.16.17.710.804.1000.990.1", "8101012222"));
            patientValueList.add(new PatientIdVO("patient.data.surname", null, "Drda"));
            patientValueList.add(new PatientIdVO("patient.data.givenname", null, "Josef"));
            List<Person> persons = serviceFacade.queryForPatient(null, patientValueList, new CountryVO("CZ", "Tjeckien", "2.16.17.710.804.1000.990.1"));
            if (persons.size() > 0) {
