...
public class DocumentInlineIFrame extends WebMarkupContainer implements IResourceListener 
{
	 ...
	 */
	public DocumentInlineIFrame(final String id, IResourceListener resourceListener)
	{
		super(id);
