 ...
 */
@Component
public class SwedenEPStatus implements NcpStatusInterface, Serializable {

    private static final long serialVersionUID = 6703367203768245199L;
    private static final Logger LOGGER = LoggerFactory.getLogger(SwedenEPStatus.class);
    ...
    public Boolean getStatus() {
        ...
        try {
            ...
            patientValueList.add(new PatientIdVO("patient.search.patient.svnr", "2.16.17.710.807.1000.990.1", "199701292394"));
            List<Person> persons = serviceFacade.queryForPatient(null, patientValueList, new CountryVO("SE", "Sverige", "2.16.17.710.807.1000.990.1"));
            if (persons.size() > 0) {
