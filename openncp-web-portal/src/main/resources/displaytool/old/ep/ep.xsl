...
<xsl:stylesheet xmlns:n1="urn:hl7-org:v3"
	...
	<xsl:template name="prescriberName">
		<xsl:choose>
			<xsl:when
				test="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:assignedPerson/n1:name/n1:prefix">
				<xsl:value-of
					select="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:assignedPerson/n1:name/n1:prefix" />
				&#160;
			</xsl:when>
		...
		<xsl:choose>
			<xsl:when
				test="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:assignedPerson/n1:name/n1:given">
				<xsl:value-of
					select="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:assignedPerson/n1:name/n1:given" />
				&#160;
			</xsl:when>
		...
		<xsl:choose>
			<xsl:when
				test="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:assignedPerson/n1:name/n1:family">
				<xsl:value-of
					select="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:assignedPerson/n1:name/n1:family" />
			</xsl:when>
		</xsl:choose>
		...
		<xsl:choose>
			<xsl:when test="($txt/n1:reference)">
				<xsl:variable name="val"
					select="substring-after($txt/n1:reference/@value,'#')" />
				<xsl:value-of
	...
	<xsl:template name="prefixCell">
		...
		<table>
			...
			<tr>
				<td colspan="3"><xsl:call-template name="epPrescriberDetails" /></td>
			</tr>
		</table>
