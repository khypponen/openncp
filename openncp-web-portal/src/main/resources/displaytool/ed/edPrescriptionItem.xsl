...
<xsl:template name="strength">
	<xsl:call-template name="show-strength">
		<xsl:with-param name="medStrengthUnit1" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:ingredient[@classCode='ACTI']/epsos:quantity/epsos:numerator/@unit"/>
		<xsl:with-param name="medStrengthUnit2" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:ingredient[@classCode='ACTI']/epsos:quantity/epsos:denominator/@unit"/>
		<xsl:with-param name="medStrengthValue1" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:ingredient[@classCode='ACTI']/epsos:quantity/epsos:numerator/@value"/>
		<xsl:with-param name="medStrengthValue2" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:ingredient[@classCode='ACTI']/epsos:quantity/epsos:denominator/@value"/>
		<xsl:with-param name="medStrength1" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:ingredient[@classCode='ACTI']/epsos:quantity/epsos:numerator"/>
		<xsl:with-param name="medStrength2" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:ingredient[@classCode='ACTI']/epsos:quantity/epsos:denominator"/>
	</xsl:call-template> 
</xsl:template>

<xsl:template name="package">
	<xsl:call-template name="show-package">
		<xsl:with-param name="medPackage" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:asContent/epsos:containerPackagedMedicine/epsos:capacityQuantity"/>
	</xsl:call-template>
</xsl:template>
...
-->
<!--
<xsl:template name="edPrescriptionItemDetails">
	...
	<table>
		...
		<tr>
			<td>
				...
				<xsl:call-template name="show-formCode">
					<xsl:with-param name="parameter" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:ingredient[@classCode='ACTI']/epsos:ingredient/epsos:code"/>
				</xsl:call-template>
			...
			<td>
				...
				<xsl:variable name="hasPackage">
					<xsl:call-template name="check-Parameter">
						<xsl:with-param name="parameter" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:asContent/epsos:containerPackagedMedicine/epsos:capacityQuantity/@nullFlavor"/>
					</xsl:call-template>
				</xsl:variable>
				...
				<xsl:choose>
					<xsl:when test="$hasPackage = 'false'">
					    <xsl:call-template name="show-noneFlavor">
									<xsl:with-param name="data" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:asContent/epsos:containerPackagedMedicine/epsos:capacityQuantity/@nullFlavor"/>
						</xsl:call-template>
					</xsl:when>
					<xsl:otherwise>
			...
			<td>
				<xsl:call-template name="show-formCode">
					<xsl:with-param name="parameter" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:formCode"/>
				</xsl:call-template>
			</td>
			<td rowspan="2">
				&#160;
		...
		<tr>
			...
			<td colspan="2">
				<xsl:value-of select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/n1:code/@code"/>						
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			<td colspan="2">
        		...
        		<input type="text">
        			...
        			<xsl:attribute name="value">
        				<xsl:value-of select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:asContent/epsos:containerPackagedMedicine/epsos:capacityQuantity/@value"/>
        			</xsl:attribute>
        		</input>
        		
					<xsl:variable name="unitMeasure">
						<xsl:value-of select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:asContent/epsos:containerPackagedMedicine/epsos:capacityQuantity/@unit"/>
					</xsl:variable>
		...
		<tr>
			...
			<td>
				...
				<xsl:variable name="currentDoseFormName">
					<xsl:call-template name="show-formCode">
						<xsl:with-param name="parameter" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:asContent/epsos:containerPackagedMedicine/epsos:formCode"/>
					</xsl:call-template>
				</xsl:variable>				
				<input type="hidden">
					<xsl:call-template name="inputform">
				...
				<input type="hidden">
					<xsl:call-template name="inputform">
						...
						<xsl:with-param name="val" select="n1:product/n1:manufacturedProduct/n1:manufacturedMaterial/epsos:asContent/epsos:quantity/epsos:numerator/@value"/>
					</xsl:call-template>
				</input>
...
-->
	...
	<xsl:template name="edPrescriptionItem">
	 <script>
		<xsl:attribute name="type">
			<xsl:text>text/javascript</xsl:text>
		</xsl:attribute>
		...
		<table style="width : 100%">
			<xsl:for-each select="$entryNodeED">
				entry node found!!
<!--
