...
<xsl:output method="html" indent="yes" version="4.01" encoding="ISO-8859-1" doctype-system="http://www.w3.org/TR/html4/strict.dtd" doctype-public="-//W3C//DTD HTML 4.01//EN"/>
	...
	<xsl:template name="edHeader">
			...
			<table class="header_table">
				...
				<tr>
          			<td><xsl:value-of select="n1:patient/n1:name/n1:prefix"/></td>
					<td><xsl:value-of select="n1:patient/n1:name/n1:family"/> </td>
					<td><xsl:value-of select="n1:patient/n1:name/n1:given"/></td>
					<td>
					...
					<td><xsl:value-of select="n1:id[1]/@extension"/></td>
					<td><xsl:value-of select="n1:id[2]/@extension"/></td>
       			</tr>
             </tbody>
		</table>
		</xsl:for-each>
