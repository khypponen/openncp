...
<xsl:template name="edPrescriberDetails">
	<a>
	...
	<tr>
		...
		<td>
			...
			<xsl:call-template name="facilityId">
				<xsl:with-param name="id" select="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:representedOrganization/n1:id"/>
			</xsl:call-template>
		</td>
		<td>
			<span class="tdtext">
			...
			<xsl:call-template name="country">
				<xsl:with-param name="name" select="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:representedOrganization/n1:addr/n1:country"/>
			</xsl:call-template>
		</td>
	</tr>
	<tr>
		<td colspan="3">
			...
			&#160;
			<xsl:call-template name="country">
				<xsl:with-param name="name" select="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:representedOrganization/n1:addr"/>
			</xsl:call-template>
		</td>
	</tr>
	<tr>
	<td>
		...
		<xsl:call-template name="organization">
			<xsl:with-param name="name" select="//n1:entry/n1:supply[n1:templateId[@root='1.3.6.1.4.1.12559.11.10.1.3.1.3.3']]/n1:participant[@typeCode='AUT']/n1:participantRole[@classCode='LIC']/n1:scopingEntity[@classCode='ORG']/n1:desc"/>
		</xsl:call-template>
	</td>
	<td colspan="2">
		<span class="tdtext">
