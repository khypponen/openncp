...
public class COCTMT230100UVPackagedMedicine {
    ...
    @XmlElementRef(name = "asSuperContent", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT230100UVSuperContent> asSuperContent;
    @XmlElementRef(name = "subContent", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    ...
    public void setAsSuperContent(JAXBElement<COCTMT230100UVSuperContent> value) {
        this.asSuperContent = ((JAXBElement<COCTMT230100UVSuperContent> ) value);
    }
    ...
    public void setSubContent(JAXBElement<COCTMT230100UVSubContent> value) {
        this.subContent = ((JAXBElement<COCTMT230100UVSubContent> ) value);
    }
