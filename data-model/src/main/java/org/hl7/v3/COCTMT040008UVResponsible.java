...
public class COCTMT040008UVResponsible {
    ...
    @XmlElementRef(name = "agentOrganization", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT150007UVOrganization> agentOrganization;
    @XmlElementRef(name = "agentPerson", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT030207UVPerson> agentPerson;
    @XmlElementRef(name = "agentDevice", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT140007UVDevice> agentDevice;
    @XmlElementRef(name = "representedOrganization", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT150007UVOrganization> representedOrganization;
    @XmlElementRef(name = "representedPerson", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    ...
    public void setAgentOrganization(JAXBElement<COCTMT150007UVOrganization> value) {
        this.agentOrganization = ((JAXBElement<COCTMT150007UVOrganization> ) value);
    }
    ...
    public void setAgentPerson(JAXBElement<COCTMT030207UVPerson> value) {
        this.agentPerson = ((JAXBElement<COCTMT030207UVPerson> ) value);
    }
    ...
    public void setAgentDevice(JAXBElement<COCTMT140007UVDevice> value) {
        this.agentDevice = ((JAXBElement<COCTMT140007UVDevice> ) value);
    }
    ...
    public void setRepresentedOrganization(JAXBElement<COCTMT150007UVOrganization> value) {
        this.representedOrganization = ((JAXBElement<COCTMT150007UVOrganization> ) value);
    }
    ...
    public void setRepresentedPerson(JAXBElement<COCTMT030207UVPerson> value) {
        this.representedPerson = ((JAXBElement<COCTMT030207UVPerson> ) value);
    }
