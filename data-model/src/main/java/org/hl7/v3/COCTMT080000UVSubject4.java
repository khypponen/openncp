...
public class COCTMT080000UVSubject4 {
    ...
    @XmlElementRef(name = "specimenObservationEvent", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT080000UVSpecimenObservationEvent> specimenObservationEvent;
    @XmlElementRef(name = "automationSpecimenObservationEvent", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    ...
    public void setSpecimenObservationEvent(JAXBElement<COCTMT080000UVSpecimenObservationEvent> value) {
        this.specimenObservationEvent = ((JAXBElement<COCTMT080000UVSpecimenObservationEvent> ) value);
    }
    ...
    public void setAutomationSpecimenObservationEvent(JAXBElement<COCTMT080000UVAutomationSpecimenObservationEvent> value) {
        this.automationSpecimenObservationEvent = ((JAXBElement<COCTMT080000UVAutomationSpecimenObservationEvent> ) value);
    }
