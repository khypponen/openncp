...
public class COCTMT080000UVSpecimen {
    ...
    @XmlElementRef(name = "sourceNatural", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT080000UVNatural> sourceNatural;
    @XmlElementRef(name = "sourceManufactured", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT080000UVManufactured> sourceManufactured;
    @XmlElementRef(name = "sourceNonPersonLivingSubject", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT080000UVNonPersonLivingSubject> sourceNonPersonLivingSubject;
    @XmlElementRef(name = "sourcePerson", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    ...
    public void setSourceNatural(JAXBElement<COCTMT080000UVNatural> value) {
        this.sourceNatural = ((JAXBElement<COCTMT080000UVNatural> ) value);
    }
    ...
    public void setSourceManufactured(JAXBElement<COCTMT080000UVManufactured> value) {
        this.sourceManufactured = ((JAXBElement<COCTMT080000UVManufactured> ) value);
    }
    ...
    public void setSourceNonPersonLivingSubject(JAXBElement<COCTMT080000UVNonPersonLivingSubject> value) {
        this.sourceNonPersonLivingSubject = ((JAXBElement<COCTMT080000UVNonPersonLivingSubject> ) value);
    }
    ...
    public void setSourcePerson(JAXBElement<COCTMT080000UVPerson> value) {
        this.sourcePerson = ((JAXBElement<COCTMT080000UVPerson> ) value);
    }
