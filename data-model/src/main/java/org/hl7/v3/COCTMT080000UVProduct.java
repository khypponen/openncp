...
public class COCTMT080000UVProduct {
    ...
    @XmlElementRef(name = "process", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT080000UVProcess> process;
    @XmlElementRef(name = "actRef", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    ...
    public void setProcess(JAXBElement<COCTMT080000UVProcess> value) {
        this.process = ((JAXBElement<COCTMT080000UVProcess> ) value);
    }
    ...
    public void setActRef(JAXBElement<COCTMT080000UVActRef> value) {
        this.actRef = ((JAXBElement<COCTMT080000UVActRef> ) value);
    }
