...
/**
 * <p>Java class for COCT_MT510000UV06.Beneficiary complex type.
 * 
...
public class COCTMT510000UV06Beneficiary {
    ...
    @XmlElementRef(name = "memberOrganization1", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT150000UV02Organization> memberOrganization1;
    @XmlElementRef(name = "memberPerson", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT030007UVPerson> memberPerson;
    @XmlElementRef(name = "memberNonPersonLivingSubject", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    protected JAXBElement<COCTMT030007UVNonPersonLivingSubject> memberNonPersonLivingSubject;
    @XmlElementRef(name = "groupOrganization", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    ...
    /**
     * Gets the value of the memberOrganization1 property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the memberOrganization1 property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link COCTMT150000UV02Organization }{@code >}
    ...
    public void setMemberOrganization1(JAXBElement<COCTMT150000UV02Organization> value) {
        this.memberOrganization1 = ((JAXBElement<COCTMT150000UV02Organization> ) value);
    }

    /**
     * Gets the value of the memberPerson property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the memberPerson property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link COCTMT030007UVPerson }{@code >}
    ...
    public void setMemberPerson(JAXBElement<COCTMT030007UVPerson> value) {
        this.memberPerson = ((JAXBElement<COCTMT030007UVPerson> ) value);
    }

    /**
     * Gets the value of the memberNonPersonLivingSubject property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the memberNonPersonLivingSubject property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link COCTMT030007UVNonPersonLivingSubject }{@code >}
    ...
    public void setMemberNonPersonLivingSubject(JAXBElement<COCTMT030007UVNonPersonLivingSubject> value) {
        this.memberNonPersonLivingSubject = ((JAXBElement<COCTMT030007UVNonPersonLivingSubject> ) value);
    }

    /**
     * Gets the value of the groupOrganization property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the groupOrganization property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link COCTMT510000UV06Organization }{@code >}
    ...
    public void setGroupOrganization(JAXBElement<COCTMT510000UV06Organization> value) {
        this.groupOrganization = ((JAXBElement<COCTMT510000UV06Organization> ) value);
    }
