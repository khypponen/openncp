...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"  xmlns:epsos="urn:epsos-org:ep:medication" >
	...
	if (document.getElementById){
		...
		if (obj.style.display == "none"){
			...
			<xsl:when test="$documentCode='56445-0'">
				<xsl:call-template name="mroCda"/><br/><br/>
			</xsl:when>
			<xsl:when test="$documentCode='34133-9'">
				<xsl:call-template name="hcerCda"/><br/><br/>
			</xsl:when>
