				...
				<tbody>
					<tr class="td_creation_date">
						...
						<xsl:call-template  name="show-displayLabels">
							 ...
							 <span class="tdtext"><xsl:call-template name="show-time">
						   ...
						   <xsl:choose>
						      <xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:administrativeGenderCode/@nullFlavor">
									<xsl:call-template name="show-noneFlavor">
										<xsl:with-param name="data" select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:administrativeGenderCode/@nullFlavor" />
									</xsl:call-template>
						      </xsl:when>
						      <xsl:otherwise>
