			 ...
			 <!-- nullflavored act -->
  			<xsl:choose>
  				<xsl:when  test="not($pregHistAct/@nullFlavor)">
                        ...
                        <a href="javascript: showhide('not($pregHistActTr'); self.focus(); void(0);">Show/Hide</a>
                        <div id="not($pregHistActTr" style="display:block">
                            <xsl:apply-templates select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section/n1:code[@code='10162-6']/../n1:text/*" />
                            <br/>
                        </div>
                        </xsl:when>
                        </xsl:choose>
