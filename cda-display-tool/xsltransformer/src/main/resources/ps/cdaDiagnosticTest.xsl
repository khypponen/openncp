	...
	<!-- if sectionTitle is not missing for alerts  (Exception alerts section is missing)-->
 	 	<xsl:when test=" ($diagSectionTitleCode='30954-2')">
  			...
  			<xsl:when test="not($nullEntry/@nullFlavor)">
                        ...
                        <a href="javascript: showhide('diagTr2'); self.focus(); void(0);">Show/Hide</a>
                        <div id="diagTr2" style="display:block">
                           <xsl:apply-templates select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section/n1:code[@code='30954-2']/../n1:text" />
                           <br/>
                        </div>
                        </xsl:when>
                        </xsl:choose>
					...
					<br/>		
                        ...
                        <xsl:choose>
                        <xsl:when test="$shownarrative='true'">
                        <a href="javascript: showhide('diagTr1'); self.focus(); void(0);">Show/Hide</a>
                        <div id="diagTr1" style="display:block">
                           <xsl:apply-templates select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section/n1:code[@code='30954-2']/../n1:text/*" />                        
                           <br/>                          
                        </div>
                        </xsl:when>
