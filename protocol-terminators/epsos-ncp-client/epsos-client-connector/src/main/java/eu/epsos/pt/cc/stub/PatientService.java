...
public class PatientService {
    ...
    public static QueryResponse list(final PatientId pid, final String countryCode, final GenericDocumentCode documentCode,
        ...
        return XcaInitGateway.crossGatewayQuery(pid, countryCode, documentCode, idAssertion, trcAssertion, Constants.PatientService);
    }
    ...
    public static RetrieveDocumentSetResponseType.DocumentResponse retrieve(
        ...
        return XcaInitGateway.crossGatewayRetrieve(document, homeCommunityId, countryCode, targetLanguage, hcpAssertion, trcAssertion, Constants.PatientService);
    }
