...
public class SAML2Validator {
	...
	private static Logger logger = Logger.getLogger(SAML2Validator.class);
        ...
        public static List<Assertion> getAssertions(Element soapHeader) {
            ...
            for (int i = 0; i < assertionList.getLength(); i++) {
                ...
                try {
                    ...
                    java.util.logging.Logger.getLogger(SAML2Validator.class.getName()).log(Level.SEVERE, null, ex);
