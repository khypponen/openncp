...
public final class ApplicationController {
	 ...
	 */
	public final static Logger LOG = Logger.getLogger("TSAM.Synchronizer");
	...
	public static void writeSyncDate() {
		...
		if (result != null && result.equals(date)) {
			...
			LOG.warning("Could not verify writing last sync date to Configuration Manager: " + date);
		}
	}
	...
	public static Date getLastSyncDate() {
		...
		try {                    
                    ...
                    LOG.log(Level.WARNING,"Could not parse following string to date: " + result,e);
		}
		return null;
	}
	...
	public static void handleSevereError(Throwable e, String msg) {
		LOG.log(Level.SEVERE, "Caught " + e.toString() + ": " + msg, e);
		LOG.severe(SHUTTING_DOWN_LOG_TEXT);
	...
	public static void lockApplication() {
		...
		try {
			...
			LOG.log(Level.WARNING,"Could not write lock file", e);
			return;
		}
	...
	public static void unlockApplication() {
		...
		try {
			...
			LOG.log(Level.WARNING, "Could not remove the pid file", e);
		}
	...
	public static boolean isApplicationLocked() {
		...
		try {
			...
			LOG.log(Level.WARNING, "Could not access the pid file", e);
		}
		return false;
	}
