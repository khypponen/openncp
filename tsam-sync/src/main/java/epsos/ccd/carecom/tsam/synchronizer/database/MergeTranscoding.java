...
public class MergeTranscoding extends HibernateUnitOfWork {
	...
	protected int unitOfWork(Session session) {
		...
		query.setParameter("transcodingAssociasionId", this.transcoding.getId(), Hibernate.LONG);
		query.setParameter("sourceConceptId", this.transcoding.getSourceId(), Hibernate.LONG);
		query.setParameter("targetConceptId", this.transcoding.getTargetId(), Hibernate.LONG);
